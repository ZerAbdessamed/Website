...
$req=mysqli_query($conn,"SELECT * FROM absence WHERE matricule='$mat'");
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/server/project/Style/absence.css">
...
<body>
    <table >
        <thead>
          ...
          <tr>
            <th>Subject</th>
            <th id="note">Number of Absences</th>
          </tr>
          </tr>
        </thead>
        <tbody>
